...
public class Home extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        postText = myView.findViewById(R.id.postText);
        ...
        mAdapter = new WishAdapter(wishList, new WishAdapter.MyAdapterListener() {
            ...
            public void likeClick(View v, final int position) {
                ...
                if ((liker.get(position) == 0)&&checker1==0&&checker2==0){
                    ...
                    final Date date1 = PostDATA.get(position).getDateTime();
                    ...
                    ArrayList<String> likesL = PostDATA.get(position).getLikes();
                    final ArrayList<likeList> likeListLike = PostDATA.get(position).getLikeList();
...
// Create and launch sign-in intent
    ...
    public void nextData(String OrderBy){
        if (lastDoc==null){
            return;
        }
        Query next = db.collection("All").orderBy(OrderBy, Query.Direction.DESCENDING).startAfter(lastDoc).limit(4);
...
try{
        postRef = db.collection("All").orderBy(OrderBy, Query.Direction.DESCENDING).limit(dataLimit);
